      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded shadow-sm p-8 md:p-10 border border-gray-100">
            ...
            {/* Result badge */}
            {t.result && (
              <div className="inline-flex items-center gap-1.5 bg-blue-100 text-blue-700
          ...
          {testimonials.length > 1 && (
            <div className="flex items-center justify-center gap-4 mt-6">
              <button
                ...
                className="w-9 h-9 rounded-full border border-gray-200 hover:border-blue-300
              ...
              <div className="flex gap-1.5">
                {testimonials.map((_, i) => (
                  <button
                    ...
                    className={`h-1.5 rounded-full transition-all ${i === current ? "w-6 bg-blue-500" : "w-1.5 bg-gray-300"
                      }`}
                  />
                ))}
              </div>
