...
const fallbackSlides = [
  ...
  {
    label:        "Structured. Focused. Result-Driven.",
    headline:     "Clear Concepts.",
    highlight:    "Confident Exams.",
    description:  "Structured notes, daily practice, and personal mentoring — everything a CA aspirant needs to clear with an exceptional rank.",
