    ...
    <div className="w-full py-6 relative group max-w-7xl mx-auto">
      ...
      >
        {categories.map((category) => (
          ...
          >
            <div className="relative w-20 h-20 lg:w-28 lg:h-28 rounded overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-gray-200 group-hover/item:border-primary group-hover/item:shadow-lg transition-all duration-300">
              {category.image ? (
                <Image
