  ...
  try {
    ...
    return res.status(200).json(
      new ApiResponsive(200, {
        title: "About Us",
        content:
          "<h2>Our Story</h2><p>CA Maker was founded by CA Mohit Kukreja with a vision to make CA Inter Audit simple, relatable, and scoring. With 6+ years of Big 4 audit experience, Mohit Sir brings real-world practical knowledge into every class.</p><p>We believe that Audit doesn't have to be complicated. Through simple explanations, practical examples, and exam-focused preparation, we've helped 1000+ students achieve their CA dreams.</p><p>Today, CA Maker stands as a trusted name in CA coaching, committed to building confident, exam-ready students.</p>",
        metaTitle: "About Us | CA Maker",
        metaDescription: "Learn more about CA Maker and CA Mohit Kukreja's mission to simplify CA Inter Audit.",
      })
    );
  } catch (error) {
  ...
  try {
    ...
    return res.status(200).json(
      new ApiResponsive(200, {
        ...
        content:
          "<h2>Course Access Information</h2><p>At CA Maker, we provide instant access to all enrolled courses. Once you complete your enrollment, you'll receive login credentials via email within 24 hours.</p><h2>Course Delivery</h2><ul><li><strong>Online Classes:</strong> Live sessions via Zoom with recordings available</li><li><strong>Study Material:</strong> Digital notes and resources in PDF format</li><li><strong>Doubt Support:</strong> WhatsApp group access for instant doubt clearing</li></ul>",
        metaTitle: "Course Access Policy | CA Maker",
  ...
  try {
    ...
    if (faqs.length > 0) {
      return res.status(200).json(
        new ApiResponsive(200, {
          faqs,
          metaTitle: "Frequently Asked Questions | CA Maker",
          metaDescription:
  ...
  try {
    ...
    if (contactContent) {
      const contactData = {
        ...
        socialLinks: {
          facebook: "https://facebook.com/camaker",
          instagram: "https://instagram.com/camaker",
          twitter: "https://twitter.com/camaker",
        },
      };
