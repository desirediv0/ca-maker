...
export const EnquiryForm = ({ productName = "", productUrl = "" }) => {
  ...
  if (isSubmitted) {
    return (
      <div className="bg-green-50 border border-green-200 rounded p-8 text-center animate-fade-in">
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 border border-input rounded bg-background focus:ring-2 focus:ring-primary focus:border-primary transition-colors"
          />
        </div>
      </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              readOnly
              className="w-full pl-10 pr-4 py-2.5 border border-input rounded bg-muted text-muted-foreground"
            />
          </div>
        </div>
      )}
      ...
      <div className="md:col-span-2">
        ...
        <div className="relative">
          ...
          <textarea
            ...
            className="w-full pl-10 pr-4 py-2.5 border border-input rounded bg-background focus:ring-2 focus:ring-primary focus:border-primary transition-colors resize-none"
          />
        </div>
      </div>
