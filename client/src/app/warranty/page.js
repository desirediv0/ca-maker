import { RiShieldCheckLine as Shield, RiCheckboxCircleLine as CheckCircle2, RiFileTextLine as FileText, RiPhoneLine as Phone } from "react-icons/ri";
import { PageHero } from "@/components/ui/PageHero";

export const metadata = {
    title: "Warranty Policy | CA-Maker",
                    ...
                    <div className="prose prose-orange lg:prose-lg max-w-none text-gray-600 prose-headings:text-gray-900 prose-p:leading-relaxed prose-li:text-gray-600 space-y-8">
                        ...
                        <div>
                            ...
                            <ol className="space-y-3 mb-8 list-decimal list-inside">
                                <li><strong>Contact Support:</strong> Email us at camakerIndia@gmail.com </li>
